...
/**
 * This wont run on CI. By default spring should run h2 if there's no other entity manager defined.
 */
@Configuration
@Profile("!ci && !dev")
public class PersistanceConfig {
    ...
    @Value("${db.password}")
    transient String databasePassword;

    @Value("${db.username}")
    transient String databseUsername;

    @Value("${db.url}")
    transient String databaseUrl;
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactoryBean() {
        ...
        em.setPackagesToScan("nl.tudelft.sem.sem54.fridge.domain");
